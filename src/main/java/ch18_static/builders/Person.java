...
public class Person {
    ...
    private Person(Builder builder) {       // 같은 클래스에 내에서만 생성자 호출 가능
    ...
    public static class Builder {       // 새로운 클래스 정의 (동일한 필드를 넣어)
        private String name;
        private int age;
        private String address;
    ...
    */
        public Builder name(String name) {
            ...
            return this;        // 여태까지는 name에 값이 없다가, 39번 코드라인 시점에 name field에
            // 값이 대입된 객체가 리턴됨.
        }
