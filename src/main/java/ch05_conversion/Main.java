...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("변형 : " + (int)cast1);       // A를 int로 형변환시 65
        ...
        // 업캐스팅 방법 # 2
        // 새로운 변수를 선언하여 캐스팅이 이루어진 데이터를 집어넣는 방법 입니다.
        char cast3 = 'b';
        int casted3 = cast3;    // 여기서는 (int)로 안 쓰였죠.
        ...
        // 지시 사항 : 다운캐스팅하는 방법을 업캐스팅 방법 # 1,2 를 참조하여 char 형으로 바꾼 후
        ...
        /*
            ...
            downcasting의 경우에는 데이터 용량이 축소되는 과정에서 변수가 메모리 용량을 벗어나게 되는 경우가 있습니다.
            (아까 강남스타일을 예시로 들었을 때 30억이 넘는 숫자를 다시 int로 형변환하게 되면 마이너스 값이 나오게 되겠죠)
            용량 오버에 해당하는 현상을 미리 점검하기 위해 다운캐스팅 시에는 명시적(explicit)으로만 변형이 가능합니다.

            -> 현재는 기본 자료형을 기준으로 예시를 들었지만 나중에는 참조자료형 캐스팅 개념과 연결됩니다.
            아마도 14번 챕터였던 걸로 기억합니다.
         */
