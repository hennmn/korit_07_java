...
//        System.out.println(arr01);  // 결과값 : [I@36baf30c
        ...
        // 현재 배열 내부에는 다수으 데이터가 있기 때문에 콘솔창에서 전체 확인이 불가능합니다.
        // 즉 elemenmt들을 확인하기 위해서는 배열 내부로 직접 탐색하는 과정이 필요합니다.
        // 이때 필요한 개념이 index(주소지라고 하기로 합니다.) 개념입니다.
//        System.out.println(arr01);      // 주소값만 출력
        ...
        for(int i = 0; i < 5; i++) {    // 5가 하드코딩 되어있음 -> literal을 그대로 썼다.
            System.out.print(arr01[i] + " ");       // i가 어디에 적용되어야 하는 지 감안할 필요가 있었다.
        }
        ...
        // bank.accountHolder와 같은 방식으로 참조 가능했습니다.
        // 그리고 field를 직접 참조했다는 말을 length 필드는 public 이라고 볼 수 있겠네요.
        ...
        //arr02는 현재까지 10개짜리 방을 지니 배열에 해당하고, 내부에는 아무런 값이 없습니다.
...
//        }
        ...
        // arr02에 현재 21, 22, 23, 24, /// , 30이 대입되어 있습니다.
        // 42, 44, 45, ... 60이 될 수 있도록 반복문을 작성하고
        // 42, 44, 46, ... , 60으로 출력하시오.
        ...
        // 그래서 다른 자료형의 배열이라도 기본적으로 element 를 추출하는 절차는 동일합니다.
