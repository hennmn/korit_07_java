...
/*
    ...
    Snake case ->  Java에서 쓸 일 x , 근데 전체 상수 사용 시에 비슷한 표기법이 적용됩니다.
...
public class Operator01 {
    public static void main(String[] args) {
        ...
        int a = 5;
        int b = 2;
        double result = (double) a / b;  // 강제'형변환'개념입니다. (double 제외시 2.0)
        System.out.println(a/b);  // 값 : 2
        System.out.println(result);  // 값 : 2.5
        // 그래서 생각보다 코딩할 때도 얘네가 멍청해서 하나하나 잘 지정해야 합니다.
        // 즉 개발자는 뭐다?
        ...
        System.out.println(j);      //  위에 더한 상태로 출력된 거라 위와 동일하게 12출력됨
        System.out.println(j--);    //
...
//        System.out.println("내년에는 " + (age + 1) + "살 입니다.");                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             "살이 됩니다.");
