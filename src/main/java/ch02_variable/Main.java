...
/*
    주석(coment) :Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링하는데,
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요. 제 이름은 이해은입니다.");
//        System.out.println(안녕하세요. 제 이름은 이해은입니다.);
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 맡게 된 이해은입니다.";
        ...
        System.out.println("" + name1 + name2 + name3);  // 결과값 : 이해은

        /*
            이상의 코드에서 알 수 있는 점은 컴퓨터가 생각보다 멍청하다.
            개발자인 저희가 하나하나 지정을 해줘야 한다는 점입니다.
            '문자'와 '문자열'은 서로 다른 개념인데,
            문자(하나)를 세 번 더했을 경우에는 더 이상 문자가 아니라 문자열로 인식되기 때문에
            원하는 방식으로 출력되지 않습니다. 156 어쩌고로 출력
            ...
            라고 알아두시면 되겠습니다.(근데 python이랑 JavaScript에서는 또 이런 구분이 없다.)
        ...
        /*
            ...
            '저는 코리아 it 아카데미 7월 국비과정을 수강하고 있는 누구누구 입니다. ?? 살입니다.
            제 전공은 어쩌고 학과이며, mbti는 어쩌고 입니다. 열심히 할게요 !!'
        ...
        mbti10 = "ISTP";
        age10 = 27;
        System.out.println("저는 코리아 it 아카데미 7월 국비 과정을 수강하고 있는 " + name10 + " 입니다." + age10 + "살 입니다.\n" + "제 전공은 " + major10 + "이고, mbti는 " + mbti10 + "입니다. 열심히 할게요 !!!!");
//        System.out.println("제 전공은 " + major10 + "이고, mbti는 " + mbti10 + "입니다. 열심히 할게요 !!!!");
