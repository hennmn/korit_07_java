...
public class StrSet {
    public static void main(String[] args) {
        // Set 객체 생성
        Set<String> strSet = new HashSet<>();   // 뻘건 거 떴을 때 alt + enter
        // List 객체도 생성
...
//        strList.addAll(strSet);
        ...
        // 중복이 제거 되어 있습니다. 결과값 : [TypeScript, python, java, React] 순서 보장 x
//        for(int i = 0; i < strSet.size(); i++) {
//            System.out.println(strSet.get);       // 순서가 보장되어 있지 않아서 get이 안 됨
//        }
        // 현재 상황에서 예를 들어 set내부에 있는 각 element들을 추출하여
        // 뒤에 "언어"라고 붙여서 java 언어, 와 같이 데이터를 조작하는 것이
        // 불가능하다는 것을 알 수 있습니다.
        // 이상의 문제 등을 이유로 set -> list로의 변환 역시 자주 쓰입니다.
        List<String> modifiedStrList = new ArrayList<>();
        modifiedStrList.addAll(strSet);     // 중복 제거한 set의 요소들을
