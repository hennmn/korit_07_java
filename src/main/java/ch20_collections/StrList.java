...
public class StrList {
    public static void main(String[] args) {
        ...
        // List의 경우 인덱스 넘버 고정은 없지만, 배열의 경우 인덱스 넘버를 고정해줘야만 합니다.
        ...
        strList.add("C#");
        strList.add("C++");
        // 순서가 보장된다고 했기 때문에 집어넣은 순서대로 값이 들어갑니다. (건너뛰고 다른 곳에 대입 불가능)
...
//        List<Person>  // 이렇게도 가능
        ...
        System.out.println(Arrays.toString(strArray));  // 메서드를 사용

        // List         - toString() 이 overriding
        ...
        /*
            이상의 이유는 List element가 명확하게 일치하는 지를 확인합니다.
            그래서 py가 phthon이라는 String 데이터의 일부이기는 하지만 element 전체를 의미하지는
        ...
        // 시험에 pop() 메서드가 나온 적이 있어서 비교해야 합니다.
