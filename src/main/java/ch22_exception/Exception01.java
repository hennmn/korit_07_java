...
/*
    ...
    오류(Error)란?
     ...
     그럼 Exception01에서 알 수 있듯이, 다수의 예외의 경우는 이미 개발자들이 정의해놓았습니다.
     예를 들어 List를 하나 정의했고, 거기에 element들을 집어넣었다고 가정하겠습니다.
     그 경우에는 List의 element들을 추출하기 위하여 반복문을 쓰게 될텐데,
...
//        }
        ...
        int b =0;
        try {
            int result = a / b;     // ArithmeticException 예외 발생 지점 -> 39번 라인이 아니라 catch문으로 넘어갑니다.
        ...
        int[] numbers = {1, 2, 3};      //ArrayIndexOutOfBoundsException
//        System.out.println(numbers[5]);
        ...
        /*
            이상의 코드라인에서 중요한 점은 catch문이 복수로 나올 수 있다는 점입니다.
            저희가 if문(leat year 관련)에 대해서 작성할 때
