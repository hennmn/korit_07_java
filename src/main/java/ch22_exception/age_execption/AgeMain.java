package ch22_exception.age_execption;
...
public class AgeMain {
    ...
    // 여기에 추가적으로 메서드 정의를 합ㄴ디ㅏ. (아까 login()처럼)
    public static void checkAge(int age) throws InvalidAgeException{
        if(age < 0 || age > 200) {
            // 조건에 맞지 않는 경우 사용자 정의 예외 발생시킬 것
            // 예외를 발생시킨다는 의미 -> 예외 객체를 생성한다는 의미입니다.
...
//        int age = scanner.nextInt();    // 전에는 여기에 바로 작성해서 넣었는데,
        // 생각해보면 여기 부분에 음수값이나 200 초과 정수를 집어넣을 수 있었습니다.
        ...
        /*
            이상의 코드에서 정상적인 데이터 한 번 / 비정상적인 데이터를 한 번 실행시켜 봤을 때의
