...
//        name = scanner.nextLine();
        /*
            ...
            2. nextLine / nextInt / 어쩌고 이런 것들이 있겠다. 구분해야겠다.
         */
//        System.out.println("연도를 입력하세요. >>> ");
//        int year = scanner.nextInt();
//        System.out.print(" 이름을 다시 입력하세요 >>>");
//        name = scanner.next();      // 입력을 lee haeeun
//        System.out.println(name);

        /*
            2. next(Int / Double, ... etc) vs. nextLine
                - nextLine은 띄어쓰기를 허용합니다.
                    -> 그래서 24번 라인 실행 결과가 lee였습니다. enter키, 즉 개행을 기준으로 데이터가 변수에 저장됨.
                - 나머지는 허용 안 합니다. 띄어쓰기 하면 잘려서 대입됩니다.
         */
...
//        System.out.println("이름 : " + name);
        /*
           ...
           그 경우 다음 nextLine()에서는 enter키를 받아들여서 빈값인 상태로 enter 를 쳤다고
           인지하게 되기 때문에
           곧장 35번 출력문으로 넘어갔기 때문입니다.

           해결 방법 : enter 키를 받아주는 nextLine()을 하나 더 만들어 줍니다.
         */
