...
public class MapList {
    public static void main(String[] args) {
        // 처음 Genefic 이 도입됐을 때는 선언했을 때, 생성자 호출했을 때 둘 다 자료형을
        // 명시했어야 하나 업데이트 되면서 선언하는 부분에만 적어주시면 됩니다.
//        List<Map<String, Object>> customers = new ArrayList<Map<String, Object>();
        ...
        /*
            ...
            문제가 없었을 겁니다.
            이유 ->"홍길동"은 String / 30 Integer로 두 클래스 다 Object의 서브클래스이기 때문
            실행 예
            name=홍길동
            rating=vip
            age=30
