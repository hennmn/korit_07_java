    ...
    public static void main(String[] args) {
        ...
        /*
             ...
             1. Map 에서는 key에 "" 가 없었고,
                JSON에서는 모든 key 에 String 자료형처럼 보이도로고 ""가 있습니다.
             2. Map에서는 key1 = value1의 형태로 작성되어 있지만
             JSON에서는 "key1":value1의 형태로 작성되어있습니다.
         */
        jsonObject1.addProperty("job", "코리아아이티국비강사");
        System.out.println(jsonObject1);
        /*
            컴퓨터 콘솔에 출력한 형태를 보니까 JSON 결과값이 길게 늘어져있습니다.
            나무위키에서는 막 엔터쳐져있는 것 같은데
            그래서, 가독성을 개선하는 방법으로 출력하기도 합니다.
            컴퓨터가 읽기 편한 방식이 아니라 사람이 읽기에 적합한 형태로 출력하는 것을
            pretty priting이라는 표현을 씁니다.
            이걸 외부에서 지원하는 방식으로 수업합니다.
         */

        Gson gson = new GsonBuilder().setPrettyPrinting().create();  // 알아두는 게 속편하니깐 기억하고 있거라
