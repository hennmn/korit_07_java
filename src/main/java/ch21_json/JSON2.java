...
public class JSON2 {
    public static void main(String[] args) {
        ...
        //하나는 한 줄로 출력하고
        // 하나는 prettyPrinting 적용시켜서 출력상의 차이를 확인해보기 위해 두 개 만들었습니다.
        ...
        /*
            ...
            하지만 아직 메서드를 배우진 앟았기 때문에 map만 생성하도록 하겠습니다.
         */
...
//        jsonObject.addProperty("username", "kim1");
//        jsonObject.addProperty("password", "9876");
...
//        jsonObject.addProperty("age", "20");
        ...
        // Map -> json 데이터로 변환
        String jsonProduct1 = gson.toJson(productMap1);        // toJson(아무거나 가능)
        ...
        /*
            ...
            즉, toJson()은 overloading 이루어졌다고 볼 수 있네요.
            ...
            형식 :
            gson.fromJson(제이슨 데이터, 바꾸고자하는_클래스명.class);
        ...
        /*
            ...
            이상이ㅢ 이유는 fromJson() 이라는 메서드명에서 알 수 있듯이
         ...
         */
        Map<String, String> userMap1 = gson.fromJson(jsonUser2, Map.class);  // Map은 pretty printing 적용x
        Map<String, String> userMap2 = gsonBuilder.fromJson(jsonUser2, Map.class);  // Map은 pretty printing 적용x
        System.out.println(userMap1);
        System.out.println(userMap2);

        /*
            그렇다면 이상의 코드처럼 Java 객체로 만든 것을 -> Json 데이터로 바꾼 다음에 -> 그걸 Map 형태로도 할 수 있겠게요.
            하지만 Map의 경우 Json으로 바꾸는 것까지는 자유인데 걔를 Java 객체로 만들고자 한다면
            클래스가 정의되어야 합니다.
            객체는 클래스라는 설계도를 기준으로 만들어진 거니까요.

            json -> jsonObject로 바꿀겁니다.
            그 말을 json =/= jsonObject라는 뜻이 되겠네요.
