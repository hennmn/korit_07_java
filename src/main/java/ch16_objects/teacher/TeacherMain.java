...
public class TeacherMain {
    public static void main(String[] args) {
        ...
        // Teacher 에서 .equals() 재정의 하기 전에는 false가 떴었습니다.
        // 그때의 경우는 teacher1 과 teacher2의 주소지까지 확인하여
        // 같은지 아닌지의 여부를 판단했다면,
        // 재정의 이후에는 field 에 입력된 데이터가 동일한지만을 체크하기 때문입니다.

        Class tClass = teacher1.getClass();
        System.out.println(tClass); // 결과값 : class ch16_objects.teah.Teacher
        System.out.println(tClass.getSimpleName()); // 결과값 : Teacher
        System.out.println(teacher1.getClass().getSimpleName());    // 결과값 : Teacher
        // 여러분은 어느 수준까지 그냥 작성할 지, 변수에 대입할 지를 조직에 따라,
        // 여러분의 성향에 따라서 결정하셔야 합니다.
        ...
        System.out.println(result2);        // 결과값 : false  내용은 같지만 다른 클래스에 있기 때문에

//        System.out.println(teacher3 instanceof Teacher);  // 오류 발생
        // teacher3의 자료형은 ch16_objects.Teacher이지
        // ch16_objects.teacher.Teacher 가 아닙니다.
