...
/*
     ...
     2. 그러면 시뻘건 거 오류 뜨는 데 알아서 처리할 것
     3. TabletFactory 고유 method인 upgrade(String model) 메서드를 call2()
     유형으로 정의하고, 객체명.upgrade("아이패드 프로 13인치 8세대");로 호출하면
     '아이패드 프로 13인치 8세대로 업그레이드합니다.' 라고 콘솔에 출력될 수 있도록 작성할 것 ✅
     4. Main.java로 이동해서
      ...
      5. 이름을 구글 태블릿 공장으로 수정할 것 -> getter를 활용하여
        ...
        8. 객체명.upgrade("구글 태블릿 10인치 2세대") 를 호출할 것
         9. Factory 클래스의 인스턴스인 factory2 객체를 생성할 것
            ...
            factory2메서드의 name은 삼성 컴퓨터 공장으로 set 하시오.✅
