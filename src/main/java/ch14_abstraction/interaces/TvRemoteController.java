...
public class TvRemoteController {
    ...
    public void onPressedPowerButton() {
        powerButton.onPressed();        // 이 상태로만 쓰려면 main에서 써야 하는데 메서드로 호출해야 하니깐 새로운 메서드를 만들고 해당 클래스에서 만들었던 버튼들을 들고옴
    }
    ...
    public void onUpChannelUpButton11() {/// /////////////////////////////////
        channelUpButton.onUp();
    }

    // 여기서 풀이법이 두 가지로 갈리게 됩니다.
    // # 1
    public String onUpChannelUpButton1() {   // onUp의 리턴타입이 String이라서 그냥 void로 하고 return에 넣으면 결과값이 안 나옴
